...
<head>
    ...
    <!-- font do google -->
    <link href="https://fonts.googleapis.com/css?family=Abel|Amatic+SC|East+Sea+Dokdo|Indie+Flower&display=swap" rel="stylesheet">
    
     <!--outra font do google -->
        ...
        <div class="row" id="c" >
            <div class="col-sm-6 pb-2" id="quemSomos">
                <div class="card" style="border: 5px outset #4BC9F2; background-color: rgb(169, 211, 234);">
                    <div class="card-body">
                        <h2 class="card-title text-center" style="color:#007BFF;">Quem Somos</h2>
            ...
            <div class="col-sm-6" id="Localizacao">
                    <div class="card" style="border: 5px outset #4BC9F2; background-color: rgb(169, 211, 234);">
                        <div class="card-body">
                            <h2 class="card-title text-center" style="color:#007BFF;">Nossa Localização</h2>
                    ...
                    <div class="card text-center" style="border: 5px outset #4BC9F2; background-color: rgb(169, 211, 234);">
                        <a href="#" class="card-link" data-toggle="modal" data-target="#modalAgendamento">
                            <div class="card-block">
                                ...
                                <img src="img/Agenda.png" alt="" class="img-fluid mt-2 mb-2">
                    ...
                    <div class="card text-center" style="border: 5px outset #4BC9F2; background-color: rgb(169, 211, 234);">
                        <a href="#" class="card-link" data-toggle="modal" data-target="#modalContatos">
                            <div class="card-block">
                                ...
                                <img src="img/iconCont.png" alt="" class="img-fluid mt-2 mb-2">
                            </div>
                        </a>
                    </div>
                </div>
